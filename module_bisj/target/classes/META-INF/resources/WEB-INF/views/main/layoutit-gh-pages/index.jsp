...
%>
<!-- Le styles -->
<link href="${basePath}asserts/css/bootstrap-combined.min.css" rel="stylesheet" type="text/css" >
<link href="${basePath}asserts/css/layoutit.css" rel="stylesheet" type="text/css" >

<!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>-->
<script type="text/javascript" src="${basePath}asserts/js/html5shiv.js"></script>
<!--<![endif]-->

<!-- Fav and touch icons -->
<link rel="shortcut icon" href="${basePath}asserts/img/favicon.png">

<script type="text/javascript" src="${basePath}asserts/js/jquery-2.0.0.min.js"></script>
<!--[if lt IE 9]>
<script type="text/javascript" src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
<![endif]-->
<script type="text/javascript" src="${basePath}asserts/js/bootstrap.min.js"></script>
<script type="text/javascript" src="${basePath}asserts/js/jquery-ui.js"></script>
<script type="text/javascript" src="${basePath}asserts/js/jquery.ui.touch-punch.min.js"></script>
<script type="text/javascript" src="${basePath}asserts/js/jquery.htmlClean.js"></script>
<script type="text/javascript" src="${basePath}asserts/ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="${basePath}asserts/ckeditor/config.js"></script>
<script type="text/javascript" src="${basePath}asserts/js/scripts.js"></script>
    ...
    <div class="row">
            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="http://justjavac.com/tools/layoutit/"><img
                            src="${basePath}asserts/img/favicon.png"> 可视化布局<span class="label">BETA</span></a>
                    <div class="nav-collapse collapse">
                        <ul class="nav" id="menu-layoutit">
                            <li class="divider-vertical"></li>
                            <li>
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="http://justjavac.com" target="_blank"><i
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                            ...
                            <li class="nav-header">
                                <div class="pull-right popover-info"><i class="icon-question-sign "></i>
                                    <div class="popover fade right">
                                        ...
                                        <div class="popover-content">在这里设置你的栅格布局, 栅格总数默认为12, 用空格分割每列的栅格值,
                                            如果您需要了解更多信息，请访问<a
                                                    target="_blank"
                                ...
                                <div class="pull-right popover-info"><i class="icon-question-sign "></i>
                                    <div class="popover fade right">
                                        ...
                                        <div class="popover-content">这里提供了一系列基本元素样式，你可以通过区块右上角的编辑按钮修改样式设置。如需了解更多信息，请访问<a
                                                target="_blank" href="http://twitter.github.io/bootstrap/base-css.html">基本CSS.</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li style="display: none;" class="boxes" id="elmBase">
                                <div class="box box-element ui-draggable"><a href="#close"
                                    ...
                                    <span class="configuration"><button type="button" class="btn btn-mini"
                                            ...
                                            class="btn-group"> <a class="btn btn-mini dropdown-toggle"
              ...
              </span> <span class="btn-group"> <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">标记 <span
                                            class="caret"></span></a>
              <ul class="dropdown-menu">
                <li class="active"><a href="#" rel="">默认</a></li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class=""><a href="#" rel="text-success">成功</a></li>
                                ...
                                <div class="box box-element ui-draggable"><a href="#close"
                                        ...
                                        data-target="#editorModal"
                                        role="button"
                                        data-toggle="modal">编辑</button> <a
                                        class="btn btn-mini" href="#" rel="unstyled">无样式</a> <a class="btn btn-mini"
                                                                                                href="#"
              ...
              </span> <a class="btn btn-mini" href="#" rel="table-hover">鼠标指示</a> <a class="btn btn-mini" href="#"
              ...
              </span> <span class="btn-group"> <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">尺寸 <span
                                        class="caret"></span></a>
              <ul class="dropdown-menu">
              ...
              </span> <a class="btn btn-mini" href="#" rel="btn-block">通栏</a> <a class="btn btn-mini" href="#"
              ...
              <ul class="dropdown-menu">
                ...
                <li class=""><a href="#" rel="img-polaroid">相框</a></li>
                                    ...
                                    <div class="view"><img alt="140x140" src="${basePath}asserts/img/a.jpg"></div>
                                </div>
                            </li>
                        </ul>
                        <ul class="nav nav-list accordion-group">
                            <li class="nav-header"><i class="icon-plus icon-white"></i> 组件
                                <div class="pull-right popover-info"><i class="icon-question-sign "></i>
                                    <div class="popover fade right">
                                        <div class="arrow"></div>
                                        <h3 class="popover-title">帮助</h3>
                                        <div class="popover-content">拖放组件到布局框内. 拖入后你可以设置组件样式. 查看这里获取更多帮助 <a
                                                target="_blank"
              ...
              </span> <span class="btn-group"> <a class="btn btn-mini dropdown-toggle" data-toggle="dropdown" href="#">位置 <span
                                        class="caret"></span></a>
              <ul class="dropdown-menu">
                ...
                <li class=""><a href="#" rel="badge-inverse">倒数</a></li>
                                ...
                                <div class="box box-element ui-draggable"><a href="#close"
                                    ...
                                    <div class="view">
                                        ...
                                        <p contenteditable="true">本可视化布局程序在HTML5浏览器上运行更加完美, 能实现自动本地化保存, 即使关闭了网页,
                                            下一次打开仍然能恢复上一次的操作.</p>
                                ...
                                <div class="box box-element ui-draggable"><a href="#close"
                                    ...
                                    <div class="view">
                                        <ul class="thumbnails">
                                            <li class="span4">
                                                <div class="thumbnail"><img alt="300x200"
                                                                            src="${basePath}asserts/img/people.jpg">
                                                    <div class="caption" contenteditable="true">
                                                        <h3>冯诺尔曼结构</h3>
                                                        <p>
                                                            也称普林斯顿结构，是一种将程序指令存储器和数据存储器合并在一起的存储器结构。程序指令存储地址和数据存储地址指向同一个存储器的不同物理位置。</p>
                                                        <p><a class="btn btn-primary" href="#">浏览</a> <a class="btn"
                                                                                                         href="#">分享</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="span4">
                                                <div class="thumbnail"><img alt="300x200"
                                                                            src="${basePath}asserts/img/city.jpg">
                                                    <div class="caption" contenteditable="true">
                                                        <h3>哈佛结构</h3>
                                                        <p>
                                            ...
                                            <li class="span4">
                                                <div class="thumbnail"><img alt="300x200"
                                                                            src="${basePath}asserts/img/sports.jpg">
                                                    <div class="caption" contenteditable="true">
                                                        <h3>改进型哈佛结构</h3>
                                                        <p>
              ...
              </span> <a class="btn btn-mini" href="#" rel="progress-striped">条纹</a> <a class="btn btn-mini" href="#"
                                                                                        rel="active">动画</a> </span>
                                ...
                                <div class="box box-element ui-draggable"><a href="#close"
                                    ...
                                    <div class="view">
                                        <div class="media"><a href="#" class="pull-left"> <img
                                                src="${basePath}asserts/img/a_002.jpg" class="media-object"> </a>
                            ...
                            <li class="nav-header"><i class="icon-plus icon-white"></i> 交互组件 <span
                                ...
                                <div class="pull-right popover-info"><i class="icon-question-sign "></i>
                                    <div class="popover fade right">
                                        <div class="arrow"></div>
                                        <h3 class="popover-title">帮助</h3>
                                        <div class="popover-content">拖放组件到布局容器. 拖入后, 你可以配置显示样式. 如果有任何疑问可访问 <a
                                                target="_blank"
                                ...
                                <div class="box box-element ui-draggable"><a href="#close"
                                    ...
                                    <div class="view">
                                        ...
                                        <a id="myModalLink" href="#myModalContainer" role="button" class="btn"
                                           data-toggle="modal" contenteditable="true">触发遮罩窗体</a>
                                        ...
                                        <div class="navbar">
                                            <div class="navbar-inner">
                                                <div class="container-fluid"><a
                                                        ...
                                                        class="icon-bar"></span> </a> <a href="#" class="brand"
                                                                                         contenteditable="true">网站名</a>
                                                    <div class="nav-collapse collapse navbar-responsive-collapse">
                                                        <ul class="nav" contenteditable="true">
                                                            ...
                                                            <li class="dropdown"><a data-toggle="dropdown"
                                                                                    class="dropdown-toggle" href="#">下拉菜单
                                                                <b
                                                                        class="caret"></b></a>
                                                                <ul class="dropdown-menu">
                                    ...
                                    <div class="view">
                                        <div class="carousel slide" id="myCarousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="item active"><img alt="" src="${basePath}asserts/img/1.jpg">
                                                    <div class="carousel-caption" contenteditable="true">
                                                        <h4>棒球</h4>
                                                        <p>棒球运动是一种以棒打球为主要特点，集体性、对抗性很强的球类运动项目，在美国、日本尤为盛行。</p>
                                                    </div>
                                                </div>
                                                <div class="item"><img alt="" src="${basePath}asserts/img/2.jpg">
                                                    <div class="carousel-caption" contenteditable="true">
                                                        <h4>冲浪</h4>
                                                        <p>
                                                ...
                                                <div class="item"><img alt="" src="${basePath}asserts/img/3.jpg">
                                                    <div class="carousel-caption" contenteditable="true">
                                                        <h4>自行车</h4>
                                                        <p>
                                            ...
                                            <a
                                                    data-slide="next" href="#myCarousel" class="right carousel-control">›</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div class="view">
                            <div class="row-fluid clearfix">
                                <div class="span12 column ui-sortable">
                                    ...
                                    <div class="box box-element ui-draggable" style="display: block; "><a href="#close"
                                                                                                          class="remove label label-important"><i
                                            class="icon-remove icon-white"></i>删除</a> <span class="drag label"><i
                                            class="icon-move"></i>拖动</span> <span class="configuration"><button
                                            type="button" class="btn btn-mini" data-target="#editorModal" role="button"
                                            data-toggle="modal">编辑</button> <a class="btn btn-mini" href="#"
                                                                               rel="well">嵌入</a> </span>
                                        <div class="preview">概述</div>
                                        <div class="view">
                                            <div class="hero-unit" contenteditable="true">
            ...
            <div class="modal-body">
                ...
                <div class="btn-group">
                    <button type="button" id="fluidPage" class="active btn btn-info"><i
                            class="icon-fullscreen icon-white"></i> 自适应宽度
                    </button>
